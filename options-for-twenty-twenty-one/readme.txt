...
This plugin is for **Twenty Twenty-One** theme, please see our other plugins for [Twenty Seventeen](https://wordpress.org/plugins/options-for-twenty-seventeen/ "Twenty Seventeen"), [Twenty Nineteen](https://wordpress.org/plugins/options-for-twenty-nineteen/ "Twenty Nineteen"), [Twenty Twenty](https://wordpress.org/plugins/options-for-twenty-twenty/ "Twenty Twenty") and [Block Themes](https://wordpress.org/plugins/template-editor/ "Block Themes") like Twenty Twenty-Two and Twenty Twenty-Three.
...
- Enable full site editing tool Template Editor introduced in WordPress v5.8
...
- Show the mobile submenu style on larger screens.
- Align mobile navigation items to the right.
...
= 1.7.7 =
* Fixed bugs with "Hide Date" and "Hide Categories" options

= 1.7.6 =
* Made PHP PSR-4 fix backwards compatible with older versions of WordPress

= 1.7.5 =
* Fixed a minor PHP PSR-4 warning

= 1.7.4 =
* Added option to show the page title on the front page

= 1.7.3 =
* Minor Sidebar bug fix

= 1.7.2 =
* Minor tranlation security updates

= 1.7.1 =
* Added option to show the mobile navigation submenu style on larger screens

= 1.7.0 =
* Fixed a bug with "Hide Date" option

= 1.6.9 =
* Fixed a bug with ignored title padding option on pages with featured images

= 1.6.8 =
* Added option to align mobile navigation items to the right
